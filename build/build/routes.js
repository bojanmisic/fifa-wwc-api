...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get('/users/:userId', ...((0, runtime_1.fetchMiddlewares)(userController_1.UsersController)), ...((0, runtime_1.fetchMiddlewares)(userController_1.UsersController.prototype.getUser)), function UsersController_getUser(request, response, next) {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/users', ...((0, runtime_1.fetchMiddlewares)(userController_1.UsersController)), ...((0, runtime_1.fetchMiddlewares)(userController_1.UsersController.prototype.createUser)), function UsersController_createUser(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const args = {
